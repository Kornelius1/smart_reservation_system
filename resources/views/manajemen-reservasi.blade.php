            ...
            <div class="card w-full bg-white shadow-xl">
                <div class="card-body">
                    <div class="flex justify-between items-center">
                        <h1 class="text-2xl font-bold text-brand-text">RESERVASI</h1>
                        <div class="form-control relative">
                            ...
                            <input id="searchInput" type="text" placeholder="Cari Reservasi" class="input input-sm input-bordered w-72 pl-10" />
                        </div>
                    </div>

                    <div class="overflow-x-auto mt-4">
                       {{-- GANTI SELURUH BAGIAN TABLE DENGAN KODE INI --}}
    ...
    <tbody class="text-brand-text">
        @foreach ($reservations as $reservation)
            <tr class="text-center">
                ...
                <td>
                    {{-- KOLOM STATUS SEKARANG BERISI BADGE TEKS --}}
                    <span class="badge badge-sm" style="border: none;"></span>
                </td>
                <td>
                    {{-- KOLOM AKSI SEKARANG BERISI TOGGLE --}}
                    <div class="flex items-center justify-center">
                        <input type="checkbox" class="toggle toggle-md" {{ $reservation['status'] ? 'checked' : '' }} />
                    </div>
                </td>
            </tr>
        @endforeach
