...
<div class="drawer-side is-drawer-close:overflow-visible">
  ...
  >
    ...
    <ul class="menu w-full grow space-y-1">
      ...
      <li>
        <a href="/manajemen-menu" class="is-drawer-close:tooltip is-drawer-close:tooltip-right" data-tip="Manajemen Menu">
      ...
      <li>
        <a href="/manajemen-meja" class="is-drawer-close:tooltip is-drawer-close:tooltip-right" data-tip="Manajemen Meja">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor"
            stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="size-5">
            <path d="M20 7h-9"></path>
            <path d="M14 17H5"></path>
      ...
      <li>
        <a href="{{ route('admin.manajemen-ruangan.index') }}" class="is-drawer-close:tooltip is-drawer-close:tooltip-right"
          data-tip="Manajemen Ruangan">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor"
            stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="size-5">
            <path d="M20 7h-9"></path>
            <path d="M14 17H5"></path>
    ...
    <div class="m-2 is-drawer-close:tooltip is-drawer-close:tooltip-right" data-tip="Open Sidebar">
      <label for="my-drawer-4" class="btn btn-ghost btn-circle drawer-button transition-transform duration-300 is-drawer-open:rotate-180">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor"
          stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="size-5">
