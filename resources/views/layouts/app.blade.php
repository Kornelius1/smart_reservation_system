...
<body style="background-color: #dfe6da; color: #414939;">
    ...
    {{-- HEADER / NAVBAR --}}
    <header class="navbar bg-secondary text-white shadow-lg"> {{-- Menggunakan warna #9CAF88 --}}
        <div class="flex-1">
            <a href="/" class="px-2">
                {{-- Menggunakan file gambar logo --}}
    ...
    {{-- FOOTER --}}
    <footer class="footer footer-center p-10 bg-neutral text-base-100 mt-10">
        <aside>
