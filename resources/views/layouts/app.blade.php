...
<head>
    ...
    {{-- Placeholder untuk judul halaman. Jika tidak diisi, akan menggunakan 'Aplikasi Saya' --}}
    <title>@yield('title', 'Homey')</title>
    ...
    {{-- Placeholder untuk styles tambahan jika ada halaman yang butuh CSS khusus --}}
    @stack('styles')
</head>
...
<body class="font-sans antialiased">
    ...
    <nav class="text-[#738764] bg-gradient-to-r from-[#e5eedb] to-[#414939] border-none text-white">
        ...
        {{-- Tanda @yield('content') adalah tempat konten unik dari setiap halaman akan disuntikkan --}}
        <main>
            @yield('content')
        </main>
