...
<div class="min-h-screen bg-beige p-8">
    ...
    <div class="grid grid-cols-4 gap-8">
        <a href="{{ route('manajemen-menu') }}" class="bg-green-400 rounded-lg p-6 flex flex-col items-center justify-center hover:bg-green-500 transition">
        ...
        <a href="{{ route('manajemen-meja') }}" class="bg-green-400 rounded-lg p-6 flex flex-col items-center justify-center hover:bg-green-500 transition">
        ...
        <a href="{{ route('manajemen-reservasi') }}" class="bg-green-400 rounded-lg p-6 flex flex-col items-center justify-center hover:bg-green-500 transition">
        ...
        <a href="/" class="bg-green-400 rounded-lg p-6 flex flex-col items-center justify-center hover:bg-green-500 transition">
