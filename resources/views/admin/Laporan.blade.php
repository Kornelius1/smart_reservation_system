...
{{-- Blok @push('styles') yang kosong dihapus --}}
...
@section('content')
    <div class="container mx-auto px-4 py-8">
        ...
        {{--
        Catatan: Blok ini secara struktural tidak salah.
        Pastikan saja ini memang disengaja sebagai sub-navigasi di dalam konten,
        dan bukan sisa dari copy-paste sidebar.
        --}}
