...
<<<<<<< HEAD
                ...
                <li class="bg-brand-background rounded-lg" title="Manajemen Menu"><a><svg
                ...
                <li class="mt-2" title="Manajemen Reservasi"><a><svg xmlns="http://www.w3.org/2000/svg" fill="none"
                            viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                            <path stroke-linecap="round" stroke-linejoin="round"
...
>>>>>>> e1e0804 (Menyelesaikan semua fitur halaman manajemen menu)
        ...
        <div class="drawer-content flex flex-col items-center p-4 lg:p-8 ml-20">
            <div class="card w-full bg-white shadow-xl">
                <div class="card-body">
                    <h1 class="text-2xl font-bold text-brand-text border-b-4 border-brand-primary pb-2">MANAJEMEN MENU
                    </h1>
                    ...
                    <div class="flex justify-start items-center my-4 space-x-4">
                        ...
                        <button id="tambahMenuBtn"
                            class="btn text-white bg-gradient-to-r from-brand-primary to-brand-primary-dark border-none">Tambah
                            Menu</button>
                    </div>
...
<<<<<<< HEAD
                                            @if ($item['tersedia'])
                                                <span
                                                    class="badge badge-sm bg-green-200 text-green-800 border-none">Available</span>
                                            @else
                                                <span class="badge badge-sm bg-gray-200 text-gray-700 border-none">Not
                                                    Available</span>
                                            @endif
                                        </td>
                                        <td>
...
>>>>>>> e1e0804 (Menyelesaikan semua fitur halaman manajemen menu)
                                                    ...
                                                    data-kategori="{{ $item['kategori'] }}" data-foto="{{ $item['foto'] }}">
                                                    Ubah Detail
                                                </button>
                                            </div>
                                        </td>
...
<<<<<<< HEAD
            <div class="py-4">
                <div class="form-control w-full"><label class="label"><span class="label-text text-brand-text">Nama
                            Menu</span></label><input type="text" placeholder="Masukkan Nama Menu"
                        class="input input-bordered w-full" /></div>
                <div class="form-control w-full mt-4"><label class="label"><span
                            class="label-text text-brand-text">Harga</span></label><label
                        class="input-group"><span>Rp</span><input type="number" placeholder="15000"
                            class="input input-bordered w-full" /></label></div>
                <div class="form-control w-full mt-4"><label class="label"><span
                            class="label-text text-brand-text">Kategori</span></label><select
...
<<<<<<< HEAD
                ...
                <div class="form-control w-full mt-4"><label class="label"><span
                            class="label-text text-brand-text">Gambar</span></label><input type="file"
                        class="file-input file-input-bordered w-full" /></div>
            </div>
            <div class="modal-action">
                <form method="dialog" class="w-full"><button
                        class="btn w-full text-white bg-gradient-to-r from-brand-primary to-brand-primary-dark border-none">Simpan</button>
                </form>
=======
                    </select>
                </div>
...
<<<<<<< HEAD
            <div class="py-4">
                <div class="form-control w-full"><label class="label"><span class="label-text text-brand-text">Nama
                            Menu</span></label><input id="ubah_nama_menu" type="text"
                        class="input input-bordered w-full" /></div>
                <div class="form-control w-full mt-4"><label class="label"><span
                            class="label-text text-brand-text">Harga</span></label><label
                        class="input-group"><span>Rp</span><input id="ubah_harga_menu" type="number"
                            class="input input-bordered w-full" /></label></div>
                <div class="form-control w-full mt-4"><label class="label"><span
                            class="label-text text-brand-text">Kategori</span></label><select id="ubah_kategori_menu"
                        class="select select-bordered w-full">
=======
            <div class="py-4 space-y-4">
                <div class="form-control w-full">
