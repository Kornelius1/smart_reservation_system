{{-- File: resources/views/Reservasi.blade.php --}}

{{-- Memberitahu Blade untuk menggunakan layout guest.blade.php --}}
@extends('layouts.guest')

{{-- Mengatur judul halaman untuk layout --}}
@section('title', 'Pilih Reservasi')

{{-- Mengisi section 'header' --}}
@section('header')
...
{{-- Mulai section 'content' yang akan dimasukkan ke @yield('content') --}}
@section('content')
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-4xl">

        <div
            class="bg-amber-50 rounded-3xl p-8 shadow-md text-center transition-transform duration-200 ease-in-out hover:scale-105">
