@extends('layouts.app') 
{{-- Ganti 'layouts.app' jika Anda menggunakan layout yang berbeda, 
    misalnya 'customer.layouts.base' --}}
...
<div class="container mx-auto px-4 py-16 min-h-screen flex items-center justify-center">
    <div class="max-w-xl w-full bg-white shadow-xl rounded-lg p-8 md:p-12 text-center">
        ...
        @if ($isSuccess)
            {{-- Tampilan Sukses --}}
            <svg class="w-20 h-20 mx-auto text-success" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
            ...
            <div class="mt-8 border rounded-lg p-4 bg-gray-50 text-left">
                ...
                <p class="text-gray-700 mb-1">
                    ...
                    <span class="font-bold text-xl text-success">Rp {{ number_format($reservation->total_price, 0, ',', '.') }}</span>
                </p>
