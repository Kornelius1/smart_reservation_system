...
class ProductSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $productsData = [
            ...
            // --- COFFEE ---
            ['name' => 'Black Coffee (hot/ice)', 'price' => 15000, 'category' => 'coffee', 'image_url' => 'images/menus/black_coffee_hot_ice.webp'],
            ...
            ['name' => 'Vietnam Drip (hot)', 'price' => 15000, 'category' => 'coffee', 'image_url' => 'images/menus/vietnam_drip_hot.webp'],
        ];
